      ...
      <nav>
        ...
        <div className="banner_group">
          <div className="links page_group">
            <Link className="page_link experience" href="/experience">
              <a>Experience</a>
            </Link>
            <Link className="page_link service" href="/service">
              <a>Service</a>
            </Link>
            <Link className="page_link priorities" href="/priorities">
              <a>Priorities</a>
            </Link>
            <Link className="page_link donate" href="/donate">
              <a>Donate</a>
            </Link>
          </div>
          <div className="links email_group">
            <div className="page_link">
              <Link
                className="page_link email"
                href="mailto:
      pat@tillmanforcountycommissioner.com"
              >
                <a>pat@tillmanforcountycommissioner.com</a>
              </Link>
            </div>
          </div>
          ...
          <div className="links social_group">
            <Link
              className="social_link FB"
              href="https://www.facebook.com/patrick.tillman.31"
            >
